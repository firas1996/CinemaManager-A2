...
namespace CinemaManager_A2.Controllers
{
    ...
    {
        CinemaDbA2Context _context;
        public ProducersController(CinemaDbA2Context context)
        {
            _context = context;
        }
        ...
        public IActionResult MyMovies (int id)
        {
            ...
            //var querry = from movie in movies where movie.ProducerId == id
            //             select movie;
            var querry = _context.Movies.Where(m => m.ProducerId == id);
